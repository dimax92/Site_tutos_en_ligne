...
const Profil = () => {
    ...
    function suppressionProfil(){
        ...
        .then((result)=>{
            axios.post("https://tutopy.com/backend/public/api/suppressionprofil/"+result.data, {
                data: {
                    popo: "salut"
                }
            }, {
              ...
              .then(function (response) {
                ...
                document.location.href='https://tutopy.com/';
              })
    ...
    function deconnexion(){
        axios.post("https://tutopy.com/backend/public/api/logout",{
            data: {
                nom: "popo"
            }}, {
            headers: {
    ...
    function envoiDonneesModification(nomClass, nom){
        ...
        .then((response)=>{
            axios.post("https://tutopy.com/backend/public/api/updateprofil/"+response.data, modificationDonnees(nomClass, nom), {
                headers: {
